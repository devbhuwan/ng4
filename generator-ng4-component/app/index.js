...
module.exports = yeoman.Base.extend({
  ...
  initializing: function () {
    ...
    this.props.licenseHeader = this.fs.read(path.join(__dirname, './ng4-license-header.ts'));
  ...
  writing: function () {
    ...
    this.props.keywords.push('ng4-component');
    ...
    if (this.props.licenseChecker) {
      pkg = _.merge(
        currentPkg,
        this.fs.readJSON(path.join(__dirname, './ng4-license-check.json'), {})
      );
    }
